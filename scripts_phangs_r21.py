...
class ToolsR21():
    ...
    def plot_model_std(
        ...
        myax_set(ax1, "both", None, [0.01,0.30], None, label1, label3, adjust=ad)
        myax_set(ax2, "both", None, [0.01,0.30], None, label1, label4, adjust=ad)
        myax_set(ax3, "both", None, [0.01,0.30], None, label2, label4, adjust=ad)
