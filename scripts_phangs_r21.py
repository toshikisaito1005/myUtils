...
class ToolsR21():
    ...
    def plot_hist_550pc(
        ...
        # plot: pctls
        factor = 1.5
        self._ax_pctls_bar(ax1, pctl_all_n0628[0], ylim_n0628, "all", ylim_factor=factor)
        self._ax_pctls_bar(ax2, pctl_all_n0628[1], ylim_n0628, None, ylim_factor=factor)
        self._ax_pctls_bar(ax3, pctl_all_n0628[2], ylim_n0628, None, ylim_factor=factor)
        self._ax_pctls_bar(ax4, pctl_all_n3627[0], ylim_n3627, "all", ylim_factor=factor)
        self._ax_pctls_bar(ax5, pctl_all_n3627[1], ylim_n3627, None, ylim_factor=factor)
        self._ax_pctls_bar(ax6, pctl_all_n3627[2], ylim_n3627, None, ylim_factor=factor)
        self._ax_pctls_bar(ax7, pctl_all_n4254[0], ylim_n4254, "all", ylim_factor=factor)
        self._ax_pctls_bar(ax8, pctl_all_n4254[1], ylim_n4254, None, ylim_factor=factor)
        self._ax_pctls_bar(ax9, pctl_all_n4254[2], ylim_n4254, None, ylim_factor=factor)
        self._ax_pctls_bar(ax10, pctl_all_n4321[0], ylim_n4321, "all", ylim_factor=factor)
        self._ax_pctls_bar(ax11, pctl_all_n4321[1], ylim_n4321, None, ylim_factor=factor)
        self._ax_pctls_bar(ax12, pctl_all_n4321[2], ylim_n4321, None, ylim_factor=factor)

        factor = 1.5-0.15
        self._ax_pctls_bar(ax1, pctl_outer_n0628[0], ylim_n0628, "outer", ylim_factor=factor, color=self.c_n0628)
        self._ax_pctls_bar(ax2, pctl_outer_n0628[1], ylim_n0628, None, ylim_factor=factor, color=self.c_n0628)
        self._ax_pctls_bar(ax3, pctl_outer_n0628[2], ylim_n0628, None, ylim_factor=factor, color=self.c_n0628)
        self._ax_pctls_bar(ax4, pctl_outer_n3627[0], ylim_n3627, "outer", ylim_factor=factor, color=self.c_n3627)
        self._ax_pctls_bar(ax5, pctl_outer_n3627[1], ylim_n3627, None, ylim_factor=factor, color=self.c_n3627)
        self._ax_pctls_bar(ax6, pctl_outer_n3627[2], ylim_n3627, None, ylim_factor=factor, color=self.c_n3627)
        self._ax_pctls_bar(ax7, pctl_outer_n4254[0], ylim_n4254, "outer", ylim_factor=factor, color=self.c_n4254)
        self._ax_pctls_bar(ax8, pctl_outer_n4254[1], ylim_n4254, None, ylim_factor=factor, color=self.c_n4254)
        self._ax_pctls_bar(ax9, pctl_outer_n4254[2], ylim_n4254, None, ylim_factor=factor, color=self.c_n4254)
        self._ax_pctls_bar(ax10, pctl_outer_n4321[0], ylim_n4321, "outer", ylim_factor=factor, color=self.c_n4321)
        self._ax_pctls_bar(ax11, pctl_outer_n4321[1], ylim_n4321, None, ylim_factor=factor, color=self.c_n4321)
        self._ax_pctls_bar(ax12, pctl_outer_n4321[2], ylim_n4321, None, ylim_factor=factor, color=self.c_n4321)

        factor = 1.5-0.15*2
        self._ax_pctls_bar(ax1, pctl_inner_n0628[0], ylim_n0628, "inner", ylim_factor=factor, color="firebrick")
        self._ax_pctls_bar(ax2, pctl_inner_n0628[1], ylim_n0628, None, ylim_factor=factor, color="firebrick")
        self._ax_pctls_bar(ax3, pctl_inner_n0628[2], ylim_n0628, None, ylim_factor=factor, color="firebrick")
        self._ax_pctls_bar(ax4, pctl_inner_n3627[0], ylim_n3627, "inner", ylim_factor=factor, color="firebrick", pos="left")
        self._ax_pctls_bar(ax5, pctl_inner_n3627[1], ylim_n3627, None, ylim_factor=factor, color="firebrick")
        self._ax_pctls_bar(ax6, pctl_inner_n3627[2], ylim_n3627, None, ylim_factor=factor, color="firebrick")
        self._ax_pctls_bar(ax7, pctl_inner_n4254[0], ylim_n4254, "inner", ylim_factor=factor, color="firebrick")
        self._ax_pctls_bar(ax8, pctl_inner_n4254[1], ylim_n4254, None, ylim_factor=factor, color="firebrick")
        self._ax_pctls_bar(ax9, pctl_inner_n4254[2], ylim_n4254, None, ylim_factor=factor, color="firebrick")
        self._ax_pctls_bar(ax10, pctl_inner_n4321[0], ylim_n4321, "inner", ylim_factor=factor, color="firebrick")
        self._ax_pctls_bar(ax11, pctl_inner_n4321[1], ylim_n4321, None, ylim_factor=factor, color="firebrick")
        self._ax_pctls_bar(ax12, pctl_inner_n4321[2], ylim_n4321, None, ylim_factor=factor, color="firebrick")
