...
class ToolsR21():
    ...
    def appendix_model(
        ...
        ax1.tick_params(labelbottom=False,labelleft=False,labelright=False,labeltop=True, adjust=False)
        ax2.tick_params(labelbottom=False,labelleft=False,labelright=False,labeltop=True, adjust=False)
        ax3.tick_params(labelbottom=True,labelleft=True,labelright=False,labeltop=False, adjust=False)
        ax4.tick_params(labelbottom=True,labelleft=False,labelright=False,labeltop=False, adjust=False)
        ax5.tick_params(labelbottom=False,labelleft=False,labelright=True,labeltop=False, adjust=False)
