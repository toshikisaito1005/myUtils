    ...
    def _get_modsn_co21(
        ...
        for i in range(len(nbins)-1):
            ...
            for j in range(nloop):
                ...
                this_mods_co21  = np.log10(10**this_mod_co21 + np.random.normal(0.0, np.log(10)*10**this_scatter, len(this_mod_co21)))
                this_modsn_co21 = np.log10(10**this_mods_co21 + np.random.normal(0.0, np.log(10)*10**this_obserr, len(this_mods_co21)))
