...
class ToolsPCA():
    ...
    def _plot_radial(
        ...
        if ann==1:
            ...
            ax.text(0.97, 0.83, "HNC(1-0)", color=cm.rainbow(1/float(len(clist)-1)), transform=ax.transAxes, weight="bold", fontsize=24, ha="right")
            ax.text(0.97, 0.73, "HCN(1-0)", color=cm.rainbow(1/float(len(clist)-1)), transform=ax.transAxes, weight="bold", fontsize=24, ha="right")
        elif ann==2:
            ...
            ax.text(0.97, 0.83, "HNC(1-0)/HCN(1-0)", color=cm.rainbow(1/float(len(clist)-1)), transform=ax.transAxes, weight="bold", fontsize=24, ha="right")
