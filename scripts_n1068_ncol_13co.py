...
class ToolsNcol():
    ...
    def _plot_scatter2(
        ...
        # text
        ax1.text(0.05,0.90, "$J$ = 1-0", color="deespkyblue", transform=ax1.transAxes, weight="bold", fontsize=26, ha="left")
        ax1.text(0.05,0.85, "$J$ = 2-1", color="deespkyblue", transform=ax1.transAxes, weight="bold", fontsize=26, ha="left")
