...
class ToolsLSTSim():
    ...
    def create_mom0(
        ...
        run_exportfits(cube_input+"_tmp3",self.mom0_input,True,True,True)
        ...
        run_exportfits(cube_tp+"_tmp3",self.mom0_tp,True,True,True)
        ...
        run_exportfits(cube_7m_tp+"_tmp3",self.mom0_7m_tp,True,True,True)
        ...
        run_exportfits(cube_lst+"_tmp3",self.mom0_lst,True,True,True)
