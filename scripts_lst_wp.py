...
class ToolsLSTSim():
    ...
    def plot_config(self):
        ...
        u_alma, v_alma = self._get_baselines(this_data,this_data,decl=30,tinteg=1)
        u_lst_center, v_lst_center = self._get_baselines(np.array([0,0]),this_data,decl=30,tinteg=1)
