...
class ToolsCIGMC():
    ...
    def plot_scatter(
        ...
        txt = ax1.text(0.03, 0.86, "CO(1-0) Clouds", color="deepskyblue", transform=ax1.transAxes, weight="bold", fontsize=24)
        txt.set_path_effects([PathEffects.withStroke(linewidth=4, foreground='w')])
        txt = ax1.text(0.03, 0.81, "[CI](1-0) Clouds", color="tomato", transform=ax1.transAxes, weight="bold", fontsize=24)
        txt.set_path_effects([PathEffects.withStroke(linewidth=4, foreground='w')])
