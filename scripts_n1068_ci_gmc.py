...
class ToolsCIGMC():
    ...
    def plot_larson(
        ...
        cut_cone = np.where((x_fov1_ci10>2) & (x_fov1_ci10<4) & (s2n_ci10>=self.snr_cprops) & (r_fov1_ci10<self.fov_diamter/2.0) & (theta>=self.theta2) & (theta<self.theta1) | (s2n_ci10>=self.snr_cprops) & (r_fov1_ci10<self.fov_diamter/2.0) & (theta>=self.theta2+180) & (theta<self.theta1+180))
