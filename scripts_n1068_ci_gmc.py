...
class ToolsCIGMC():
    ...
    def plot_scatter(
        ...
        # plot co10 cone
        ax1.scatter(x2_co10, y2_co10, facecolor='none', lw=2, s=70, marker="s", alpha=1.0, zorder=1e9)

        # plot ci10 cone
        ax1.scatter(x2_ci10, y2_ci10, facecolor='none', lw=2, s=70, marker="o", alpha=1.0, zorder=1e9)
