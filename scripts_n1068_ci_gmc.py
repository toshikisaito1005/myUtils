...
class ToolsCIGMC():
    ...
    def plot_scatter(
        ...
        self._scatter_hist(x_ci10, y_ci10, ax1, ax2, ax3, "mistyrose", xlim, ylim, "o", offset=0.15)
        ...
        # pctl bar xaxis
        ypos = 0.97 * (ylim[1] - ylim[0]) + ylim[0]
        ax1.plot([np.percentile(x_ci10,16),np.percentile(x_ci10,84)], [ypos,ypos], '-', color="mistyrose", lw=3)
        ax1.scatter(np.percentile(x_ci10,50), ypos, marker='o', s=100, color="mistyrose", zorder=1e9)
        ...
        # pctl bar yaxis
        xpos = 0.97 * (xlim[1] - xlim[0]) + xlim[0]
        ax1.plot([xpos,xpos], [np.percentile(y_ci10,16),np.percentile(y_ci10,84)], '-', color="mistyrose", lw=3)
        ax1.scatter(xpos, np.percentile(y_ci10,50), marker='o', s=100, color="mistyrose", zorder=1e9)
        ...
        txt = ax1.text(0.03, 0.90, "[CI] Clouds", color="mistyrose", transform=ax1.transAxes, weight="bold", fontsize=20)
