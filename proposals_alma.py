...
class ProposalsALMA():
    ...
    def c10_plot_mask_map(
        ...
        os.system("rm -rf template.image")
        run_roundsmooth(self.outfits_mask+"_tmp1",self.outfits_mask+"_tmp1b",1.0,delin=True)
        ...
        run_immath_two(self.image_oiiioii+"_regrid4",self.outfits_mask+"_tmp3",self.outfits_mask+"_tmp4","iif(IM0>0,4,IM1)",delin=True)
